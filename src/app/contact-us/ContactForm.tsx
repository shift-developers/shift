  ...
  return (
    <form onSubmit={formik.handleSubmit} className="flex flex-col gap-5">
      <div className="flex flex-col gap-1">
        <label htmlFor="email" className="text-base font-proxima font-bold">
          Email <span className="text-sm text-neutral-750">(required)</span>
        </label>
        <input
          id="email"
          name="email"
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          onChange={formik.handleChange}
        />
        <label htmlFor="newsletter" className="text-base font-proxima font-bold">
          Sign up for news and updates
        </label>
      </div>

      <label htmlFor="firstName" className="text-base font-proxima font-bold">
      ...
      <div className="grid grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="lastName" className="text-base font-proxima font-bold">
            Last Name
          </label>
          <input
            id="lastName"
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="role" className="text-base font-proxima font-bold">
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="zipCode" className="text-base font-proxima font-bold">
          Zip Code <span className="text-sm text-neutral-750">(required)</span>
        </label>
        <input
          id="zipCode"
          name="zipCode"
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="message" className="text-base font-proxima font-bold">
      ...
      <p className="text-center font-proxima text-neutral-750">
        ...
        privacy policy and consent to receive email communication from us. Your
        Information is 100% secure and will never be shared with anyone. You can
