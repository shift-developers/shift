          ...
          <div className="my-container flex items-center lg:justify-end h-full">
            <div className="flex flex-col gap-5 lg:text-3xl font-proxima font-bold text-white max-w-[500px] z-[1] mt-6">
              ...
              <p>
                ...
                scientifically-backed, data-driven approach, distinguishing us
                from other mental health products.
              </p>
            </div>
          </div>
      ...
      <section className="px-5 lg:px-32 xl:px-48 mt-20 lg:mt-[200px] lg:mb-[100px]">
        <div className="flex flex-col gap-6 text-center items-center justify-center max-w-[880px] mx-auto">
          ...
          <p className="text-xl lg:text-2xl font-proxima text-neutral-750">
            SHiFT&apos;s therapist-led MasterSessions provide you with direct
            access to the same powerful tools, strategies, and inner work that
            have changed thousands of lives. This is your chance to do the work
            - guided by experts who bring both lived and clinical experience.
            This self-paced transformational journey, combined with our
            revolutionary community learning approach, gives you the support,
            accountability, and connection you need to live your best life.
          </p>
